...
\begin{figure}
\begin{fullwidth}
{\includegraphics[width=0.65\textwidth]{figures/prefs_distance/prefs_distance.pdf}} \\
{\includegraphics[width=1.3\textwidth]{figures/BG505-to-BF520_diffprefs.pdf}}
\caption{\label{fig:bf520_prefs_logo}
The re-scaled averaged site-specific amino-acid preferences for BF520.
This figure is the same as Fig \ref{fig:bg505_prefs_logo}, but for BF520 instead of BG505.
}
\figdata{The data plotted in this figure are in \texttt{BG505\_to\_BF520\_prefs\_dist.csv}.}
\end{fullwidth}
\end{figure}
\FloatBarrier
