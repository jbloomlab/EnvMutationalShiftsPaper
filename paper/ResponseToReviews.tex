...
{\color{black}
We have clarified that we used the SupT1.CCR5 cell line. This cell line is a SupT1 clone that was lentiviral transduced to also express CCR5 in addition to CXCR4 and CD4, which SupT1 cells express naturally.
}
